...
!developmentChains.includes(network.name)
    ...
    : describe("FundMe", async () => {
          ...
          const sendValue = ethers.utils.parseEther("1") // 1e18 to 1 ETH
          beforeEach(async () => {
              // const accounts = await ethers.getSigners()
              deployer = (await getNamedAccounts()).deployer
              // deploy the contracts that are taged "all"
          ...
          describe("fund", async () => {
              //to check the require(msg.value.getConversionRate(getPriceFeed) >= MINIMUM_USD,...)
